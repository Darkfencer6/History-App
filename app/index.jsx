        ...
        <View className="w-full justify-center, items-center min-h-screenh-[85vh] px-4">
              ...
              <View className="relative mt-5">
                  <Text className="text-2xl text-white font-u_bold text-center">
                    Welcome To History App You can Learn Every thing that you dont know the past!
                  </Text>
              </View>
            <Text className="text-sm, font-j_bold text-gray-100 mt-7 text-center"> Join us, Let's Discover Together!
            </Text>
            <CustomButton
